...
{
  function createResource($accesstoken,$refreshtoken,$event_date,$starttimeh)
  {

    $authorization_header = 'Bearer '.$accesstoken;
    $resource_uri = 'https://outlook.office365.com/api/v1.0/me/events';
    $resource_body = '{ "Subject": "Appointment Details:", "Body": { "ContentType": "HTML", "Content": "your appointment is scheduled as follows:" }, "Start": "'.$event_date.''.$starttimeh.'", "End": "'.$event_date.'", "Attendees": [ { "EmailAddress": { "Address": "Admin@xtreamit.onmicrosoft.com", "Name": "Janet Schorr" }, "Type": "Required" } ] }';
    echo $resource_body;
...
function InsertEventFull()
 {
    ...
    $httpfulClient1 = new HttpFulClient1();
     $httpfulClientResp = $httpfulClient1->createResource($_SESSION['access_token'],$_SESSION['refresh_token'],$event_date,$starttimeh);
