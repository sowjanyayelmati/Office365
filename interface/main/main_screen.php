...
$sanitize_all_escapes=true;
 session_start();
// $codeac=$_SESSION['codeac'];
// echo $codeac;
/* Include our required headers */
require_once('../globals.php');
require_once("$srcdir/formdata.inc.php");

// Extract access_token & refresh_token from QUERY_STRING to the session variable
$access = $_SERVER['QUERY_STRING'];
$parsed_url = parse_url($access);
$url_parts = explode('=',$parsed_url['path']);
$access_token = str_replace("&refresh_token", "", $url_parts[3]);
$refresh_token=$url_parts[4];
...
else if (isset($_GET['mode']) && $_GET['mode'] == "lo
") {
